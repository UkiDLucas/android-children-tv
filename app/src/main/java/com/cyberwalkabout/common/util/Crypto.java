...
public class Crypto
{
	...
	public static class Base64
	{
		 ...
		 * @return The Base64-encoded object
		 * @throws java.io.IOException if there is an error
		 * @see Crypto.Base64#GZIP
		 * @see Crypto.Base64#DO_BREAK_LINES
		 * @since 2.0
		 */
		...
		/**
		 * A {@link Crypto.Base64.InputStream} will read data from another
		...
		public static class InputStream extends java.io.FilterInputStream
		{
			...
			/**
			 * Constructs a {@link Crypto.Base64.InputStream} in DECODE mode.
			 *
			...
			/**
			 * Constructs a {@link Crypto.Base64.InputStream} in
			 ...
			 * @param in      the <tt>java.io.InputStream</tt> from which to read data.
			 * @param options Specified options
			 * @see Crypto.Base64#ENCODE
			 * @see Crypto.Base64#DECODE
			 * @see Crypto.Base64#DO_BREAK_LINES
			 * @since 2.0
			 */
		...
		/**
		 * A {@link Crypto.Base64.OutputStream} will write data to another
		...
		public static class OutputStream extends java.io.FilterOutputStream
		{
			...
			/**
			 * Constructs a {@link Crypto.Base64.OutputStream} in ENCODE mode.
			 *
			...
			/**
			 * Constructs a {@link Crypto.Base64.OutputStream} in
			 * either ENCODE or DECODE mode.
			 * <p/>
			 * Valid options:<pre>
			 *   ENCODE or DECODE: Encode or Decode as data is read.
