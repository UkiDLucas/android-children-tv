...
import com.cyberwalkabout.common.location.base.IStrictMode;
import com.cyberwalkabout.common.location.base.LocationUpdateRequester;
import com.cyberwalkabout.common.location.base.SharedPreferenceSaver;
...
public class PlatformSpecificImplementationFactory {
	...
	public static IStrictMode getStrictMode() {
		if (LocationConstants.SUPPORTS_HONEYCOMB) return new HoneycombStrictMode();
		else if (LocationConstants.SUPPORTS_GINGERBREAD) return new LegacyStrictMode();
		else return null;
	}
