package com.cyberwalkabout.childrentv.util;
...
public class ListScrollDistanceCalculator implements AbsListView.OnScrollListener {
    ...
    public ListScrollDistanceCalculator(ScrollDistanceListener mScrollDistanceListener) {
        this.mScrollDistanceListener = mScrollDistanceListener;
    }
