...
import com.cyberwalkabout.childrentv.util.ShareUtils;
import com.cyberwalkabout.social.SNServices;
...
public class AboutUs extends AbstractActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_share_this_app) {
            view.post(new Runnable() {
                @Override
                public void run() {
                    SNServices.share("", getString(R.string.app_name) + " app " + getString(R.string.app_market_url_short), Uri.EMPTY, AboutUs.this, ShareUtils.getShareSettings(AboutUs.this).updateAppName(AboutUs.this.getString(R.string.app_name)));
                }
            });
            ...
            ShareUtils.sendEmail(AboutUs.this, getString(R.string.feedback_email_subject, versionName), "", getString(R.string.feedback_email));
            ...
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(getString(R.string.cyberwalkabout_page_url))));
        } else if (view.getId() == R.id.btn_suggest_video) {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(getString(R.string.video_submision_form_url)));
            startActivity(i);
    ...
    private void setupNavigationBar() {
        ...
        ImageButton btnBack = (ImageButton) findViewById(R.id.right_btn);
