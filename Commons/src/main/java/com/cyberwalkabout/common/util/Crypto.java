...
public class Crypto
{
	...
	public static class Base64
	{
		 ...
		 * @return The Base64-encoded object
		 * @throws java.io.IOException if there is an error
		 * @see com.cyberwalkabout.common.util.Crypto.Base64#GZIP
		 * @see com.cyberwalkabout.common.util.Crypto.Base64#DO_BREAK_LINES
		 * @since 2.0
		 */
		...
		public static byte[] decodeFromFile(String filename) throws IOException
		{
			...
			try
			{
				...
				// Open a stream
				bis = new InputStream(new java.io.BufferedInputStream(new FileInputStream(file)), DECODE);
		...
		public static String encodeFromFile(String filename) throws IOException
		{
			...
			try
			{
				...
				// Open a stream
				bis = new InputStream(new java.io.BufferedInputStream(new FileInputStream(file)), ENCODE);
		...
		/**
		 * A {@link com.cyberwalkabout.common.util.Crypto.Base64.InputStream} will read data from another
		 * <tt>java.io.InputStream</tt>, given in the constructor,
		 * and encode/decode to/from Base64 notation on the fly.
		 *
		 * @see com.cyberwalkabout.common.util.Crypto.Base64
		 * @since 1.3
		 */
		public static class InputStream extends java.io.FilterInputStream
		{
			...
			/**
			 * Constructs a {@link com.cyberwalkabout.common.util.Crypto.Base64.InputStream} in DECODE mode.
			 *
			...
			/**
			 * Constructs a {@link com.cyberwalkabout.common.util.Crypto.Base64.InputStream} in
			 ...
			 * @param in      the <tt>java.io.InputStream</tt> from which to read data.
			 * @param options Specified options
			 * @see com.cyberwalkabout.common.util.Crypto.Base64#ENCODE
			 * @see com.cyberwalkabout.common.util.Crypto.Base64#DECODE
			 * @see com.cyberwalkabout.common.util.Crypto.Base64#DO_BREAK_LINES
			 * @since 2.0
			 */
		...
		/**
		 * A {@link com.cyberwalkabout.common.util.Crypto.Base64.OutputStream} will write data to another
		...
		public static class OutputStream extends java.io.FilterOutputStream
		{
			...
			/**
			 * Constructs a {@link com.cyberwalkabout.common.util.Crypto.Base64.OutputStream} in ENCODE mode.
			 *
			...
			/**
			 * Constructs a {@link com.cyberwalkabout.common.util.Crypto.Base64.OutputStream} in
			 * either ENCODE or DECODE mode.
			 * <p/>
			 * Valid options:<pre>
			 *   ENCODE or DECODE: Encode or Decode as data is read.
