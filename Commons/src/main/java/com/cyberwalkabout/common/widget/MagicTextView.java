...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            String typefaceName = a.getString( R.styleable.MagicTextView_fontname);
            if(typefaceName != null) {
                setCustomFont(getContext(), typefaceName);
            }

            if(a.hasValue(R.styleable.MagicTextView_foregroundcolor)){
                Drawable foreground = a.getDrawable(R.styleable.MagicTextView_foregroundcolor);
                if(foreground != null){
                    this.setForegroundDrawable(foreground);
                }else{
                    this.setTextColor(a.getColor(R.styleable.MagicTextView_foregroundcolor, 0xff000000));
                }
            }
            ...
            if(a.hasValue(R.styleable.MagicTextView_backgroundcolor)){
                ...
                if(background != null){
                    ...
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_backgroundcolor, 0xff000000));
                }
            }
            ...
            if(a.hasValue(R.styleable.MagicTextView_MagicTextView_strokeColor)){
                float strokeWidth = a.getFloat(R.styleable.MagicTextView_MagicTextView_strokeWidth, 1);
                int strokeColor = a.getColor(R.styleable.MagicTextView_MagicTextView_strokeColor, 0xff000000);
    ...
    public boolean setCustomFont(Context ctx, String asset) {
        ...
        if (asset != null) {
            try {
                ...
                Log.e(MagicTextView.class.getSimpleName(), "Could not get typeface: " + asset + " " + e.getMessage());
                return false;
            }
            setTypeface(tf);
            return true;
